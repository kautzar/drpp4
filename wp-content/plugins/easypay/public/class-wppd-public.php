...
// add new option
      ...
      <input type="radio" name="actualamount_option" id="amount-' . $amount . '" value="' . $amount . '" maxlength="255">' . $amount . '</label>';
        ...
        $wppd_gateway_fields .= '<div class="form-group component">
            <label class="col-lg-4 control-label">' . __('Amount (you need to pay) *', 'easypay') . '</label><div class="input-block ' . $easypay_options['easypay_amt_field_size'] . '"><input type="text" class="form-control" name="actualamount" id="actualamount" placeholder="0.00" value="' . $actualamount . '" maxlength="10" ' . $amt_readonly . ' required />' . '&nbsp;' . $wppd_pay_currency . '
                    <div class="fees">+' . __('Paypal Fees extra', 'easypay') . ': <span id="payFees">0.00</span> </div>
                </div>
        </div>';
        ...
        $wppd_gateway_fields .= '<div class="form-group component">
            <label class="col-lg-4 control-label">' . __('Total Amount to be paid', 'easypay') . '</label>
  ...
  <label for="paypal"><input id="paypal" value="paypal" type="radio"  data-fee="'.$easypay_options['easypay_paypal_fee'].'" name="gateway" checked="checked" required><strong>' . __('PayPal', 'easypay') . '</strong></label></div>
      ...
      <div class="panel panel-default">
        ...
        $wppd_form_direct_submit1 = ($easypay_stripe_setting['easypay_strip_enable']) ? '<div class="radio">
  <label for="stripe"><input id="stripe" value="stripe" type="radio"  data-fee="0.0" name="gateway" required><strong>' . __('Stripe', 'easypay') . '</strong></label></div>
      ...
      <div class="panel panel-default">
        ...
        $wppd_payment_submit = '<fieldset><legend>&nbsp;</legend><div class="form-group component">
				...
				<input type="Submit" id="payDirectSubmit" class="pull-right col-lg-4 btn btn-default" name="payDirectSubmit" value="' . __('Pay Now', 'easypay') . '" />
				</div></div></fieldset>';
