...
function charity_portfolio_post_type() {
	...
	$labels = array(
		'name'                => _x( 'Portfolioes', 'Post Type General Name', 'charity' ),
		'singular_name'       => _x( 'Portfolio', 'Post Type Singular Name', 'charity' ),
		'menu_name'           => __( 'Portfolio', 'charity' ),
		'name_admin_bar'      => __( 'Portfolio', 'charity' ),
