...
function charity_causes_post_type() {
	...
	$labels = array(
		'name'                => _x( 'Causes', 'Post Type General Name', 'charity' ),
		'singular_name'       => _x( 'Causes', 'Post Type Singular Name', 'charity' ),
		'menu_name'           => __( 'Causes', 'charity' ),
...
function causes_category_taxonomy() {
	...
	$args = array(
		...
		'show_tagcloud'              => true,
		'rewrite' => array( 'slug' => 'causes-type' ),
	);
	flush_rewrite_rules();
...
function causes_location_taxonomy() {
	...
	$args = array(
		...
		'show_in_nav_menus'          => false,
		'show_tagcloud'              => false,
		'rewrite'               	 => array( 'slug' => 'causes-location' ),
	);
	flush_rewrite_rules();
