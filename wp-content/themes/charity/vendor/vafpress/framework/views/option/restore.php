<div class="vp-field charity-oneclick-wrap charity-online-option">
    <?php if (!empty($_REQUEST['oneclk']) && $_REQUEST['oneclk'] == 'succes'): ?>
        ...
        <p><?php _e("Please ", "charity"); ?> <a href="<?php echo site_url(); ?>" target="_blank"><?php _e("Click here", "charity"); ?></a> <?php _e("for visit site.", "charity"); ?></p>
    <?php else: ?>
        ...
        <b><i class="fa fa-hand-o-right"></i> <?php _e("Note:", "charity"); ?></b>
        <p><?php _e("If your oneclick installation does not work, choose offline ( Manual ) installation.", "charity"); ?></p>
    <?php endif; ?>
...
function charity_plugins_status() {
    ...
    $plugins = array(
        ...
        'events-manager' => array('name' => 'Events Manager', 'path' => 'events-manager/events-manager.php'),
        'wpbakery-visual-composer' => array('name' => 'WPBakery Visual Composer', 'path' => 'js_composer/js_composer.php'),
    );
