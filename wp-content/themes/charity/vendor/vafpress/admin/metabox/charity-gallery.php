...
return array(
    ...
    'template' => array(
        array(
            ...
            'label' => __('Choose type: Select image/gallery or videos to upload', 'charity'),
            'items' => array(
                array(
                    'value' => 'image',
        ...
        array(
            ...
            'fields' => array(
                array(
                    ...
                    'description' => __('Upload image gallery here', 'charity'),
                ),
            ),
            'dependency' => array(
        ...
        array(
            ...
            'fields' => array(
                array(
                    ...
                    'label' => __('Image', 'charity'),
                    'description' => __('Upload image for video here', 'charity'),
                ),
                array(
                    'type' => 'textbox',
