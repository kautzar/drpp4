        ...
        if (count($galleryImage) == 1):
            foreach ($galleryImage as $imgkey => $imgval):
                ...
                <a class="fancybox-effects-a img-thumb" href="<?php echo esc_url($imgval['upload-gallery-or-image']); ?>">
                    <img src="<?php echo esc_url(charity_resize($imgval['upload-gallery-or-image'], 600, 400)); ?>" alt="<?php the_title(); ?>">
                </a>
                <?php
            endforeach;
        else:
                ...
                <ul class="slides">
                    ...
                    if (!empty($galleryImage)):
                        foreach ($galleryImage as $imgkey => $imgval):
                            ...
                            <li>
                                <a class="img-thumb" href="javascript:;"><img src="<?php echo esc_url(charity_resize($imgval['upload-gallery-or-image'], 600, 400)); ?>" alt=""></a>
                            </li>													
                <?php endforeach;
            endif;
            ?>
