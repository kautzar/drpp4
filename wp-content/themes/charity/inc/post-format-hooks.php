...
class CharityPostFormatHooks {
    ...
    function latestFormatAttribute() {
        ...
        ?>
        <span class="date"><?php
        if ($charityHome3 == "attribute"):
            ?><i class="fa fa-calendar font-icon"></i><?php
        endif;


        echo get_the_date("d F, Y");
        ?></span><span class="posted-in"><?php
        if ($charityHome3 == "attribute"):
            ?><i class="fa fa-tag font-icon"></i><?php
        endif;
                ...
                <ul class="slides">
                    ...
                    foreach ($metaValueGallery as $gallerykey => $galleryval):
                        if (!empty($galleryval['gallery_image'])):
                            ...
                            <li>
                            <?php  ?>	
                            	<img src="<?php echo esc_url(charity_resize($galleryval['gallery_image'], $width, $height)); ?>" alt="<?php echo esc_attr($gallerykey); ?>" >
                            </li>        
                            <?php
                        endif;
                    endforeach;
