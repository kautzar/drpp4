...
class Charity_about_widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		<div class="footer-logo">
								<a title="Welcome to Charity" href="<?php echo esc_url(site_url()) ?>"><?php print($instance['title']); ?></a>
							</div>
							<p><?php print($instance['text']); ?></p>
							<div class="btn-wrapper">
								<a class="btn btn-default" href="<?php echo esc_url($instance['buttonlink1']); ?>"><?php print($instance['buttontext1']); ?></a>
								<a class="btn btn-default" href="<?php echo esc_url($instance['buttonlink2']); ?>"><?php print($instance['buttontext2']); ?></a>
							</div>
