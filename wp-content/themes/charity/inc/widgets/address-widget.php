...
class WP_Widget_Address extends WP_Widget {
	...
	public function update( $new_instance, $old_instance ) {
		...
		$new_instance = wp_parse_args((array) $new_instance, array( 'title' => '', 'text' => '', 'address' => '','phoneNo'=>'','mailId'=>''));
	...
	public function form( $instance ) {
		$instance = wp_parse_args( (array) $instance, array( 'title' => '', 'text' => '', 'address' => '','phoneNo'=>'','mailId'=>'' ) );
