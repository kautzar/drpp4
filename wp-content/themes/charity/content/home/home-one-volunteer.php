...
<section class="parallax-section parallax" style="background-image: url(http://localhost/drpp4/wp-content/uploads/2015/08/Foto-Ibuk-dan-dua-anaknya.jpg)">
	<div class="container">
		<div class="row">
			<div class="col-xs-12 col-sm-7 col-md-5">
				<!--h2><?php print($title); ?></h2>
				<p><?php print($content); ?></p-->
				<h2 style="color:black">Join Membership</h2>
				<p style="color:black">Become Our Member Now</p>
				<a href="http://localhost/drpp" style="border-color:black; color:black" class="btn btn-default btn-lg join-today">JOIN TODAY</a>
			</div>
		</div>
	</div>
</section>
